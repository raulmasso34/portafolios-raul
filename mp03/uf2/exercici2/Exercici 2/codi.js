...
function quickSortAndPopulate() {
  ...
  populateTable(pokemonObjects); // Crida funció per a la taula
 }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 function insertionSortAndPopulate() {
  const resultElement = document.getElementById("temps"); // Obtenir resultat
  const startTime = performance.now(); // Obtenir temps inicial
  pokemonObjects = insertionSort(pokemonObjects); // Crida funció
  const endTime = performance.now(); // Obtenir temps final
  const elapsedTime = endTime - startTime; // Càlcul temps en milisegons
 ...
 function bubbleSortAndPopulate() {
  const resultElement = document.getElementById("temps"); // Obtenir resultat
  const startTime = performance.now(); // Obtenir temps incial
  pokemonObjects = bubbleSort(pokemonObjects); // Crida funció
  const endTime = performance.now(); // Obtenir temps final
  const elapsedTime = endTime - startTime; // Càlcul temps en milisegons
...
function mix() {
  const resultElement = document.getElementById("temps"); // Obtenir resultat
  const startTime = performance.now(); // Obtenir temps incial
  pokemonObjects = mixIt(pokemonObjects); // Crida funció
